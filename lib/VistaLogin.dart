                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Text("Boost life", style: TextStyle(
                        fontSize: 50.0, fontFamily: 'PacificoRegular',
                      ),
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: TextStyle(fontFamily: 'NarrowRegular',
                          fontSize: 17.0,
                    ...
                    Container(
                      ...
                      child: Container(
                        height: 37.0,
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(5.0),color: Color(0xFF0098F3),),
                        child: Row(mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            Image.asset("assets/fb.png"),
                            SizedBox(width: 20.0,),
                            Text("Inicia sesión con Facebook", style: TextStyle(color: Colors.white, fontSize: 18.0, fontFamily: 'NarrowRegular',),),
                          ],
                        ),
                      ),
                    ),
                            ...
                            Container(
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      labelStyle: TextStyle(fontSize: 16.0,fontFamily: 'NarrowRegular')
                                  ),
                                )
                            ),
                            SizedBox(height: 10.0,),
                    ...
                    Container(
                      ...
                      child: Container(
                        height: 37.0,
                        decoration: BoxDecoration(borderRadius: BorderRadius.circular(5.0),color: Color(0xFF51B955),),
                        child: Row(mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            Icon(Icons.verified_user, color: Colors.white,),
                            SizedBox(width: 20.0,),
                            Text("Registrate", style: TextStyle(color: Colors.white, fontSize: 18.0, fontFamily: 'NarrowRegular',),),
                          ],
                        ),
                      ),
                    ),
